...
#define N_PIXELS 30 // number of pixels in LED strand
#define N 200 // Number of samples to take each time readSamples is called
#define fadeDelay 20 // delay time for each fade amount
#define noiseLevel 1 // slope level of average mic noise without sound
